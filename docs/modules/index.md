...
| `from corio import markup` | `html` | [markup](markup.md) |
| `from corio import https` | `http` | [https](https.md) |
...
| `from corio import plat` | - | [plat](plat.md) |
...
| `from corio import strings` | - | [strings](strings.md) |
...
- `from corio import logger` -> [logs](logs.md)
- `from corio import Constants` -> [path](path.md)
- `from corio import Client` -> [https](https.md)
